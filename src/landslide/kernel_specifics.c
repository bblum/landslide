...
bool kern_mutex_initing(cpu_t *cpu, unsigned int eip,
...
bool kern_mutex_blocking(cpu_t *cpu, unsigned int eip, unsigned int *owner_tid)
{
#ifdef PINTOS_KERNEL
	if (false) {
#else
...
bool kern_thread_runnable(cpu_t *cpu, unsigned int eip, unsigned int *tid)
{
...
bool kern_thread_descheduling(cpu_t *cpu, unsigned int eip, unsigned int *tid)
{
...
bool kern_page_alloc_entering(cpu_t *cpu, unsigned int eip, unsigned int *size) { return false; }
bool kern_page_alloc_exiting(cpu_t *cpu, unsigned int eip, unsigned int *base) { return false; }
bool kern_page_free_entering(cpu_t *cpu, unsigned int eip, unsigned int *base) { return false; }
